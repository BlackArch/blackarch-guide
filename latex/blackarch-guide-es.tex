...
\section{¿Qué es BlackArch Linux?}
BlackArch es una completa distribuci\'on de Linux para penetration testers y security researchers.
Es una distribuci\'on derivada de \href{https://www.archlinux.org/}{ArchLinux} por lo que los
usuarios podran instalar componentes individuales o grupos de componentes directamente sobre
esta distribuci\'on.
...
El repositorio en constante expansi\'on incluye \href{https://www.blackarch.org/tools.html}{1300} herramientas.
Todas las herramientas son probadas antes de ser agregadas al codigo base para mantener la calidad del repositorio.
...
Ejecuta \href{https://blackarch.org/strap.sh}{strap.sh} como administrador y sigue
las instrucciones. Mira el ejemplo siguiente.
\begin{lstlisting}
...
\item Para instalar una categoria, ejecute
\begin{lstlisting}
  pacman -S blackarch-<category>
\end{lstlisting}

\item Para ver las categorias de BlackArch, ejecute
\begin{lstlisting}
...
Para obtener m\'as informaci\'on, lea (u hojee) lo siguiente:
\begin{itemize}
...
pertenecer a Blackarch como mínimo, tambi\'en habrá\'a mucho cruce con
...
\textif{son programas que incrustan malware dentro de otros ejecutables.}
...
Usted puede encontrar el repositorio git principal de  BlackArch aquí:
...
\subsection{Scripts}
Aquí hay una referencia para los scripts en el directorio \verb|scripts/| :
...
Esta sección muestra c\'omo contribuir al proyecto BlackArch Linux. Nosotros aceptamos pull request de todos los tamaños, desde pequeñas correcciones de errores tipogr\'aficos hasta nuevos paquetes.
...
(también puede usar pacaur) para obtener un archivo PKGBUILD preexistente 
\textbf{nfsshell} de \href{https://aur.archlinux.org/}{AUR} y ajústarlo de acuerdo a nuestras necesidades.
...
no serás capaz de empujar upstream sin ellos.
