...
Der folgende Abschnitt zeigt, wie man das BlackArch Repositorz einrichtet und Pakete installiert. BlackArch unterstützt sowohl die Installation von Binärpaketen als auch die Installation über selbstkompilierten Quellcode. 
...
Führe \href{https://blackarch.org/strap.sh}{strap.sh} als root und folge den Anweisungen. 
...
\begin{enumerate}
\item Um alle verfügbaren Tools aufzulistenÖ
\begin{lstlisting}
