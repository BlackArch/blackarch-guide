...
\begin{tabularx}{\linewidth}{lX}
		...
		\textbf{A:} & You must first get an ISO on the \href{https://www.blackarch.org/downloads.html}{Downloads} page and install it by following the instructions of the installation script. You can find a tutorial to show the process step by step at this URL \href{https://www.blackarch.org/blackarch-install.html}{Blackarch-Installation}. If you encounter any problems and need help, the best place to ask is in our \href{irc://irc.freenode.net/blackarch}{FREENODE IRC channel} (\#blackarch).
		\vspace{0.5cm} \\
...
If you still cannot find a solution to your problem, visit our \href{irc://irc.freenode.net/blackarch}{IRC channel} and ask for help. But please be advised, BlackArch users are in different parts of the globe (different time zones). Therefore, be patient. Ask your question and wait for a reply.
	\vspace{0.7cm} \\
	\textbf{Q:} & I would like to help. What can I do? \vspace{0.2cm} \\
	\textbf{A:} & BlackArch Linux is a huge project, we are adding new applications and features everyday. If you would like to help us with anything, visit our \href{irc://irc.freenode.net/blackarch}{IRC Kanal}. Just remember to wait for a reply, we are in different time zones.
	\vspace{0.7cm} \\
\end{tabularx}
\subsection{Authors}
