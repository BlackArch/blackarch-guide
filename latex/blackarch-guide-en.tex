...
\usepackage{fancyhdr}
\usepackage{fancyvrb}
\usepackage[paper=a4paper,left=18mm,right=18mm,top=35mm,bottom=35mm]{geometry} %define margins..
\usepackage{graphicx}
\usepackage{hyperref}
\usepackage{ifpdf}
\usepackage{listings}
...
category.\\
\\
The constantly expanding repository currently includes over \href{https://www.blackarch.org/tools.html}{2553} tools.
...
\begin{lstlisting}
   ...
   sha1sum strap.sh # should be: 6f152b79419491db92c1fdde3fad2d445f09aae3
   sudo ./strap.sh
\end{lstlisting}
