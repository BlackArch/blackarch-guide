...
BlackArch Linux is an \href{https://www.archlinux.org/}{ArchLinux}-based
distribution for penetration testers and security researchers. You can install
tools individually or in groups. BlackArch Linux is compatible with
...
category.
\\\\
We currently have over \href{https://www.blackarch.org/tools.html}{1300} tools
in our toolset and the repository is constantly expanding. All tools are
thoroughly tested before being added to the codebase to maintain the quality of
the repository.
