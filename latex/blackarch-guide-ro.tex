...
\item Manualul Dezvoltatorulu -Cum sa contribui in proiect
...
{unofficial user repository} deci, poti instala BlackArch intr-o instalatie Arch Linux obisnuita. Pachetele pot fi instalate separat sau pe categorii
...
\section{Istoria lui BlackArch Linux}
Incurand...
...
\sectiunea{Instalare}
Urmatiarea sectiune iti va arata cum sa instalezi  BlackArch repository si cum sa instalezi pachete. BlackArch suporta ambele variante , instalarea din repository folosind
...
Ca parte din o, you can build the BlackArch
packages from source. Poti gasi PKGBUILDs in
...
\subsection{Pasii pentru contributie}
